...
Helium console had a limit of max 21 devices reported this way. I am not sure if the limit is still present (if you are setting it up it shows 'All Available Packets', but after you save the packet configuration it says up to 21 packets).
